        ...
        <div>
          ...
          <div className="space-y-4 text-gray-600 text-sm sm:text-base leading-relaxed">
            <p>
              ...
              financial institution established in 2003, dedicated to providing
              accessible, innovative, and customer-centric banking solutions. We
              serve individuals, entrepreneurs, small businesses, and
              organizations with a strong focus on financial inclusion, digital
            ...
            <p>
              Rooted in excellence and guided by integrity, we are committed to
              helping our customers grow, thrive, and achieve lasting financial
              success.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 sm:mt-12 grid grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
              ...
              intellectually promote creativity. To serve as an instrument of
              wealth creation.
            </p>
          </div>
        </div>
