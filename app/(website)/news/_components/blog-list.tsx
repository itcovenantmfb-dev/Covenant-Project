...
const BlogPostCard: React.FC<{ post: NewsArticle }> = ({ post }) => (
  <article className="flex flex-col sm:flex-row items-center bg-white rounded-2xl shadow-sm shadow-gray-900/5 ring-1 ring-gray-900/5 overflow-hidden">
    <div
      className="relative w-full sm:w-2/5 h-48 sm:h-[200px] md:h-full flex-shrink-0 
                p-2 sm:p-0 rounded-2xl"
    >
          ...
          <div className="text-center py-16 px-8 border border-gray-200 rounded-xl bg-gray-50/30">
            <div className="mx-auto max-w-md">
              <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-gray-100 mb-6">
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M8.25 21v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21"
                  />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-2">
              ...
              <p className="text-gray-600 mb-6">
                We don't have any news articles published at the moment. Check
                back soon for the latest updates and announcements!
              </p>
