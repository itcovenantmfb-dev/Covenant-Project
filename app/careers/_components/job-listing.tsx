...
const JobCard: React.FC<{ job: Job }> = ({ job }) => (
  <article className="relative flex h-[28rem] sm:h-[30rem] w-full max-w-sm sm:max-w-md mx-auto flex-col overflow-hidden rounded-2xl bg-white ring-1 ring-gray-200">
