    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-3 gap-8 items-stretch">
          {/* For New Clients */}
          <div className="bg-[#e8f4f1] rounded-2xl p-8">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 flex flex-col justify-center">
            <div className="flex items-start gap-4 mb-6">
              <div className="w-12 h-12 bg-[#1D9B5E]/10 rounded-full flex items-center justify-center flex-shrink-0">
                <svg 
                  className="w-6 h-6 text-[#1D9B5E]" 
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
                >
            ...
            <button className="w-full bg-[#1D9B5E] hover:bg-[#168a54] text-white font-semibold py-4 px-6 rounded-xl transition-colors duration-300">
              Contact Us Now
            </button>
          </div>
        </div>
